...
class Sheep(Agent):
    ...
    def update(self, gameState):
        ...
        boundsInfluence = self.computeBoundaryInfluence(
            gameState.getWorldBounds()).normalize()
        obstacleInfluence = self.computeObstacleInfluence(
            gameState.getGraph().obstacles).normalize()
