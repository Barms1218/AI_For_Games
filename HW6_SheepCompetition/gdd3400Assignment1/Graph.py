...
class Graph():
    ...
    def findPath_Djikstra(self, start, end):
        ...
        while priority_queue:
            ...
            for neighbor in currNode.neighbors:
                neighbor.costFromStart = currNode.costFromStart + \
                    self.calculate_cost(currNode, neighbor)
    ...
    def findPath_AStar(self, start, end):
        ...
        while priority_queue:
            ...
            for neighbor in currNode.neighbors:
                neighbor.costFromStart = self.calculate_cost(
                    currNode, neighbor) + currNode.costFromStart
                neighbor.costToEnd = self.calculateHeuristic(
                    neighbor, end_node)
                new_cost = neighbor.costFromStart + neighbor.costToEnd
